...
def test_union_duplicates():
    ...
    set_b = [
        create_mock_result('physics', 'doc1.txt:1-10', 0.90, 'thermodynamics'),  # Same location, higher score
    ]
...
def test_intersect_basic():
    ...
    assert result[0]['location'] == 'doc1.txt:1-10', f"Expected doc1.txt:1-10, got {result[0]['location']}"
...
def test_complex_scenario():
    ...
    print(f"✓ Complex operation: Union produced {len(union_result)} results, difference excluded 1, final: {len(final_result)}")
