...
print("=" * 80)
result1 = search(
    query="ollama API integration", corpuses=["gitingest"], top_k=5, verbose=True, temperature=0.0
)
...
print("=" * 80)
result2 = search(
    query="How to cook pasta?", corpuses=["gitingest"], top_k=5, verbose=True, temperature=0.0
)
